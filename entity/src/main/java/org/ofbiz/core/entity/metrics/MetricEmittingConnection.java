...
/**
 * This class wraps around {@link Connection} and emits metrics
 *
 * @since 2.0
 */
public class MetricEmittingConnection implements Connection {

    private final Connection delegate;
    private final Ticker ticker;
    @VisibleForTesting
    protected MetricEmittingConnection(Connection delegate, Ticker ticker) {
    ...
    public static Connection wrapWithMetrics(Connection connection) {
        Ticker ticker = metric("start.ofbiz.timer")
                .withInvokerPluginKey()
                .startLongRunningTimer();
        return new MetricEmittingConnection(connection, ticker);
    }
